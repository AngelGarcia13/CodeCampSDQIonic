...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('tab.speeches', {
    ...
    views: {
      'tab-speeches': {
        templateUrl: 'templates/tab-speeches.html',
        controller: 'SpeechesCtrl'
      }
    }
  })
    .state('tab.speech-detail', {
      url: '/speeches/:speechId',
      views: {
        'tab-speeches': {
          templateUrl: 'templates/speech-detail.html',
          controller: 'SpeechDetailCtrl'
        }
      }
    })
  ...
  $urlRouterProvider.otherwise('/tab/speeches');
